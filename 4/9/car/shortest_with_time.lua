...
--  else
  ...
  result.is_startpoint = highway ~= "motorway" and tunnel == "" and (result.forward_mode == mode_normal or result.backward_mode == mode_normal)

  result.name = tostring(math.max(result.forward_speed, result.backward_speed))
end
